        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">Edit Email Details</h4>
                </div>
            </div>
        </div>
        <div class="row">
                                        ...
                                        <div class="edit-profile__body">
                                            <form action="{{ route('emails.update', $email->id) }}" method="post">
                                                ...
                                                <div class="form-group mb-25">
                                                    ...
                                                    <input type="text" class="form-control" id="identifier_name" name="identifier_name" value="{{ old('identifier_name', $email->identifier_name) }}" placeholder="Unique identifier..." required>
                                                </div>

                                                <div class="form-group mb-25">
                                                    <label for="subject">Email Subject</label>
                                                    <input type="text" class="form-control" id="subject" name="subject" value="{{ old('subject', $email->subject) }}" placeholder="Enter email subject..." required>
                                                </div>

                                                <div class="form-group mb-25">
                                                    <label for="description">Email Description</label>
                                                    <textarea class="form-control" id="description" name="description" rows="4" placeholder="Enter email description..." required>{{ old('description', $email->description) }}</textarea>
                                                </div>

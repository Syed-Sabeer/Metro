        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex align-items-center user-member__title mb-30 mt-30">
                    <h4 class="text-capitalize">Add Admin</h4>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <div class="col-xxl-8 col-10">
                                    <div class="mt-sm-40 mb-sm-50 mt-20 mb-20">
                                        <div class="user-tab-info-title mb-sm-40 mb-20 text-capitalize">
                                            <h5 class="fw-500">Admin Information</h5>
                                        </div>
                                        @if ($errors->any())
                                            ...
                                            <form action="{{ route('store.admin') }}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group mb-25 col-md-6">
                                                        ...
                                                        <input type="number" class="form-control" id="zipcode" name="zipcode" placeholder="Enter ZipCode">
                                                    </div>


                                                    <div class="form-group mb-25 col-md-6">
                                                        <label for="country">Country</label>
                                                        <input type="text" class="form-control" id="country" value="United States" name="country" placeholder="Enter Country">
                                                    </div>
